...
exports.restParameterType = exports.isAlwaysUnknownSymbol = exports.TypeTranslator = exports.symbolToDebugString = exports.typeToDebugString = exports.typeValueConflictHandled = exports.isDeclaredInClutzDts = exports.isDeclaredInBuiltinLibDTS = exports.isValidClosurePropertyName = void 0;
...
exports.isDeclaredInClutzDts = isDeclaredInClutzDts;
/**
...
class TypeTranslator {
    ...
    constructor(host, typeChecker, node, pathUnknownSymbolsSet, symbolsToAliasedNames, symbolToNameCache, ensureSymbolDeclared = () => { }) {
         ...
         * statement.
         */
        this.useInternalNamespaceForExterns = false;
        /**
    ...
    symbolToString(sym) {
        ...
        const context = (0, transformer_util_1.nodeIsInTransformedNs)(this.node) ?
            this.node.getSourceFile() :
            this.node;
        const name = this.typeChecker.symbolToEntityName(sym, ts.SymbolFlags.Type, context, ts.NodeBuilderFlags.UseFullyQualifiedType |
    ...
    maybeGetMangledNamePrefix(symbol) {
        ...
        const mangled = (0, annotator_host_1.moduleNameAsIdentifier)(this.host, fileName, context);
    ...
    translate(type) {
            ...
            for (const decl of type.symbol.declarations || []) {
                ...
                while (current) {
                    ...
                    if (current.kind === ts.SyntaxKind.ModuleDeclaration &&
                        !(0, transformer_util_1.isMergedDeclaration)(current)) {
        ...
        switch (type.flags & mask) {
            ...
            case ts.TypeFlags.Intersection:
                if (((_d = type.aliasSymbol) === null || _d === void 0 ? void 0 : _d.escapedName) === 'NonNullable' &&
                    isDeclaredInBuiltinLibDTS((_e = type.aliasSymbol.declarations) === null || _e === void 0 ? void 0 : _e[0])) {
                    let innerSymbol = undefined;
                    // Pretend that NonNullable<T> is really just T, as this doesn't
                    // tend to affect optimization. T might not be a symbol we can
                    // represent in Closure's type-system, and in this case we fall
                    // back to '?' (the old behavior).
                    if ((_f = type.aliasTypeArguments) === null || _f === void 0 ? void 0 : _f[0]) {
                        innerSymbol = this.translate(type.aliasTypeArguments[0]);
                    }
                    else {
                        const srcFile = this.node.getSourceFile().fileName;
                ...
                if (((_g = type.aliasSymbol) === null || _g === void 0 ? void 0 : _g.escapedName) === 'gbigint') {
                    return '!gbigint';
                }
    ...
    translateObject(type) {
        ...
        if (type.objectFlags & ts.ObjectFlags.Class) {
            ...
            const maxExpectedTypeArgs = ((_b = localTypeParameters === null || localTypeParameters === void 0 ? void 0 : localTypeParameters.length) !== null && _b !== void 0 ? _b : 0) + 1;
