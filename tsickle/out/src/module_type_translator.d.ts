...
export declare class ModuleTypeTranslator {
    ...
    private readonly useInternalNamespaceForExterns;
    /**
    ...
    constructor(sourceFile: ts.SourceFile, typeChecker: ts.TypeChecker, host: AnnotatorHost & googmodule.GoogModuleProcessorHost, diagnostics: ts.Diagnostic[], isForExterns: boolean, useInternalNamespaceForExterns?: boolean);
     ...
     *     emit a `.default`.
     */
    requireType(context: ts.Node, importPath: string, moduleSymbol: ts.Symbol, isDefaultImport?: boolean, leaveModulesAlone?: boolean): void;
    /**
     ...
     */
    registerImportSymbolAliases(googNamespace: string | undefined, isDefaultImport: boolean, moduleSymbol: ts.Symbol, getAliasPrefix: (symbol: ts.Symbol) => string): void;
    /**
     ...
     */
    registerExternSymbolAliases(importPath: string, moduleSymbol: ts.Symbol): void;
