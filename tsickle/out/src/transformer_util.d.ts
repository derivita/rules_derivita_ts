 ...
 */
export declare function isMergedDeclaration(decl: ts.Declaration): boolean;
/**
 * Mark the declaration as being transformed by namespaceTransformer.
 */
export declare function markAsMergedDeclaration(decl: ts.Declaration): void;
/**
 ...
 */
export declare function getTransformedNs(node: ts.Node): ts.ModuleDeclaration | null;
/**
 * Returns true if node (or its original if updated) is contained inside a
 * namespace that has been transformed by namespaceTransformer.
 */
export declare function nodeIsInTransformedNs(node: ts.Node): boolean;
/**
 * Returns first non-ambient declaration of given symbol before textual position
 * of 'thisDecl'.
 */
export declare function getPreviousDeclaration(sym: ts.Symbol, thisDecl: ts.Declaration): ts.Declaration | null;
