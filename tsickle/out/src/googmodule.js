...
exports.commonJsToGoogmoduleTransformer = exports.getAmbientModuleSymbol = exports.getOriginalGoogModuleFromComment = exports.extractModuleMarker = exports.jsPathToStripProperty = exports.localJsPathToNamespace = exports.jsPathToNamespace = void 0;
...
exports.jsPathToNamespace = jsPathToNamespace;
/**
 * Resolves an import path to its goog namespace, if it points to an original
...
exports.localJsPathToNamespace = localJsPathToNamespace;
/**
...
exports.jsPathToStripProperty = jsPathToStripProperty;
/**
...
function getExportedDeclarations(sourceFile, typeChecker) {
    ...
    for (const exportSymbol of exportSymbols) {
        const declarationSymbol = exportSymbol.flags & ts.SymbolFlags.Alias ?
            ...
            exportSymbol;
        const declarationFile = (_a = declarationSymbol.valueDeclaration) === null || _a === void 0 ? void 0 : _a.getSourceFile();
        if ((declarationFile === null || declarationFile === void 0 ? void 0 : declarationFile.fileName) !== sourceFile.fileName)
            continue;
        result.push({
        ...
        return (sf) => {
            ...
            function maybeCreateGoogRequire(original, call, newIdent) {
                ...
                if (!existingImport) {
                    ...
                    initializer =
                        (0, transformer_util_1.createGoogCall)('require', (0, transformer_util_1.createSingleQuoteStringLiteral)(imp));
                }
                else {
            ...
            function maybeRewriteDecoratedClassChainInitializer(stmt, decl) {
                ...
                const updatedDecl = ts.factory.updateVariableDeclaration(decl, decl.name, decl.exclamationToken, decl.type, decl.initializer.right);
                const newStmt = ts.factory.updateVariableStatement(stmt, stmt.modifiers, ts.factory.updateVariableDeclarationList(stmt.declarationList, [updatedDecl]));
                return {
                    statement: newStmt,
                    exports: [
                        ts.factory.createExpressionStatement(ts.factory.createAssignment(decl.initializer.left, decl.name)),
                    ],
                };
            }
            /**
            ...
            function isExportsAssignmentForDecoratedClass(stmt) {
                ...
                if (ts.isVariableStatement(ts.getOriginalNode(stmt)))
                    return false;
            ...
            function maybeRewriteExportsAssignmentInIifeArguments(stmt) {
                ...
                const notAlreadyExported = matchingExports.filter(decl => !ts.isClassDeclaration(decl.declarationSymbol.valueDeclaration) &&
                ...
                return {
                    statement: stmt,
                    exports: exportNames.map(exportName => ts.factory.createExpressionStatement(ts.factory.createAssignment(ts.factory.createPropertyAccessExpression(ts.factory.createIdentifier('exports'), ts.factory.createIdentifier(exportName)), name))),
                };
            }
            /**
            ...
            function rewriteDynamicRequire(node) {
                ...
                const imp = importPathToGoogNamespace(host, importedUrl, ignoredDiagnostics, sf, importedUrl.text, () => getAmbientModuleSymbol(typeChecker, importedUrl));
                modulesManifest.addReferencedModule(sf.fileName, imp);
                return (0, transformer_util_1.createGoogCall)('requireDynamic', (0, transformer_util_1.createSingleQuoteStringLiteral)(imp));
            }
