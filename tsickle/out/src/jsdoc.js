 ...
 * comment.
 */
const ONE_LINER_TAGS = new Set(['type', 'typedef', 'nocollapse', 'const', 'enum']);
/**
...
exports.getMutableJSDoc = getMutableJSDoc;
    ...
    for (let i = comments.length - 1; i >= 0; i--) {
        ...
        if (parsed) {
            if (diagnostics !== undefined && parsed.warnings) {
                ...
                (0, transformer_util_1.reportDiagnostic)(diagnostics, node, parsed.warnings.join('\n'), range, ts.DiagnosticCategory.Warning);
            }
