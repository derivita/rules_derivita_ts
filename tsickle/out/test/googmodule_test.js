...
const googmodule = __importStar(require("../src/googmodule"));
const modules_manifest_1 = require("../src/modules_manifest");
const testSupport = __importStar(require("./test_support"));
function processES5(fileName, content, { isES5 = true, pathToNamespaceMap } = {}) {
    ...
    const host = {
        ...
        pathToModuleName: (context, fileName) => testSupport.pathToModuleName(rootDir, context, fileName, options, tsHost),
        options,
        transformDynamicImport: 'closure',
    };
    if (pathToNamespaceMap) {
        host.jsPathToModuleName = (importPath) => { var _a; return (_a = pathToNamespaceMap.get(importPath)) === null || _a === void 0 ? void 0 : _a.name; };
        host.jsPathToStripProperty = (importPath) => { var _a; return (_a = pathToNamespaceMap.get(importPath)) === null || _a === void 0 ? void 0 : _a.stripProperty; };
    }
...
describe('convertCommonJsToGoogModule', () => {
    ...
    describe('resolve clutz modules with host provided methods', () => {
        ...
        it('resolves strip property', () => {
            expectCommonJs('a.ts', `import {prop} from 'path/to/strip/prop'; console.log(prop);`)
                .toBe(outdent(`
            goog.module('a');
            var module = module || { id: 'a.ts' };
            goog.require('tslib');
