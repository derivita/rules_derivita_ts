    ...
    for (const test of testSupport.goldenTests()) {
        ...
        it(test.name, () => {
            ...
            const transformerHost = {
                ...
                useDeclarationMergingTransformation: test.isNamespaceTransformationEnabled,
                ...
                pathToModuleName: (context, importPath) => {
                    return testSupport.pathToModuleName(tsCompilerOptions.rootDir, context, importPath, tsCompilerOptions, tsHost);
                },
