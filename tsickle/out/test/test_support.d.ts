 ...
 */
export declare function pathToModuleName(rootModulePath: string, context: string, fileName: string, options: ts.CompilerOptions, host: ts.ModuleResolutionHost): string;
