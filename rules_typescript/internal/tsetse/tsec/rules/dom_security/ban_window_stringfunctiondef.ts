...
import {AbsoluteMatcher} from '../../../util/absolute_matcher';
import {shouldExamineNode} from '../../../util/ast_tools';
import {isExpressionOfAllowedTrustedType} from '../../../util/is_trusted_type';
import {PropertyMatcher} from '../../../util/property_matcher';
import {TRUSTED_SCRIPT} from '../../../util/trusted_types_configuration';
